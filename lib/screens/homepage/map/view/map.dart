...
import 'package:rideshare_app/screens/homepage/map/widget/buttonOFReservatioin.dart';
                ...
                children: [
                  ...
                  BlocBuilder<HubsBloc, HubsState>(
                    builder: (context, state) {
                      if (state is SuccessGetHubs) {
                        return MarkerLayer(
                          markers:
                            ...
                            if (index == state.listOfHubs.length - 1) {
                              ...
                              return Marker(
                                  point: LatLng(
                                      state.listOfHubs[index].latitude
                                          .toDouble(),
                      ...
                      } else if (state is LoadingGetHubs) {
                        return const Center(
                        ...
                        return const Center(
                            child: Text(
                                "there is no connection, please try again latter!"));
                      } else {
                        return const Center(
                          child: CircularProgressIndicator(),
                        );
